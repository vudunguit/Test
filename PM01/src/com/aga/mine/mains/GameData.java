...
public class GameData {
	...
	//
	// 게임 모드
	final int kGameModeSingle = 1;
	final int kGameModeRandom = 2;
	final int kGameModeInvite = 3;
	
	// 게임 난이도
	final int kGameDifficultyEasy = 1;
	final int kGameDifficultyNormal = 2;
	final int kGameDifficultyHard = 3;
